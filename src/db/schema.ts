...
export const users = pgTable("atlas_users", {
...
export const sessions = pgTable("atlas_sessions", {
  id: text("id").primaryKey(),
...
export const accounts = pgTable("atlas_accounts", {
  id: text("id").primaryKey(),
...
export const verifications = pgTable("atlas_verifications", {
  id: text("id").primaryKey(),
